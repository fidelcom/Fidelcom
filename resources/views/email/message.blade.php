...
<head>
    ...
    <title>{{$email->title}} | {{ $email->app_name }}</title>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                            ...
                                                            <img src="{{config('app.url')}}/img/kv_logo.png" alt=""
                                                                 style="width: 100%;">
                                                            <!-- <div style="position: relative; width: 100%;">
        <img src="{{config('app.url')}}/img/logs.jpg" alt="" style="width: 100%;">
        <img src="{{config('app.url')}}/img/favicon.png" alt="" style="position: absolute; top: 0; right: 0; width: 50px; height: 50px;">
      </div> -->
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    {{-- <h2 style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello
                                                            ,</span></h2>
                                                    <p style="font-size: 14px; line-height: 140%;">&nbsp;
                                                    </p> --}}
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 18px; line-height: 25.2px; color: #666666;">{!! $email->body !!}</span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 140%;">&nbsp;
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                                    style="font-size: 16px; line-height: 22.4px;">Thanks,<br>
                                                                                {{ $email->app_name }}</span></em></span><br/><span
                                                            style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
            ...
            <div class="u-row-container" style="padding: 0px;background-color: transparent">
                <div class="u-row"
                     style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #46cbe3;">
                    <div
                        style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                        <!--[if (mso)|(IE)]>
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding: 0px;background-color: transparent;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
                                        <tr style="background-color: #46cbe3;"><![endif]-->
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Lato',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">LLC, 8 The Green, Suite B, Dover, DE 19901, United States</span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">K123 Ikota Shopping complex, Ajah, Lekki, Lagos.</span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">+2347059988777 | hello@kidyview.com</span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;"><a
                                                                href="https://mysecureview.com/unsubscribe-notification">Unsubscribe</a></span>
                                                    </p>
                                                </div>
                                                            ...
                                                            <tr style="vertical-align: top">
                                                                <td align="left" valign="middle"
                                                                    ...
                                                                    <a href=" " title="Facebook"
                                                                       target="_blank">
                                                                        <img
                                                                            src="{{config('app.url')}}/images/image-3.png"
                                                                            alt="Facebook"
                                                                            title="Facebook"
                                                                            width="32"
                                                            ...
                                                            <tr style="vertical-align: top">
                                                                <td align="left" valign="middle"
                                                                    ...
                                                                    <a href=" " title="Twitter"
                                                                       target="_blank">
                                                                        <img
                                                                            src="{{config('app.url')}}/images/image-6.png"
                                                                            alt="Twitter"
                                                                            title="Twitter"
                                                                            width="32"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                            ...
                                                            <tr style="vertical-align: top">
                                                                <td align="left" valign="middle"
                                                                    ...
                                                                    <a href=" "
                                                                       ...
                                                                       target="_blank">
                                                                        <img
                                                                            src="{{config('app.url')}}/images/image-5.png"
                                                                            alt="Instagram"
                                                                            title="Instagram"
                                                                            width="32"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                            ...
                                                            <tr style="vertical-align: top">
                                                                <td align="left" valign="middle"
                                                                    ...
                                                                    <a href=" " title="LinkedIn"
                                                                       target="_blank">
                                                                        <img
                                                                            src="{{config('app.url')}}/images/image-4.png"
                                                                            alt="LinkedIn"
                                                                            title="LinkedIn"
                                                                            width="32"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                    ...
                                                    <p style="line-height: 140%; font-size: 14px;"><span
                                                            style="font-size: 14px; line-height: 19.6px;"><span
                                                                style="color: #ecf0f1; font-size: 14px; line-height: 19.6px;"><span
                                                                    style="line-height: 19.6px; font-size: 14px;">{{ config('app.name') }}
                                                                    &copy;&nbsp; All Rights
                                    ...
                                    <table style="font-family:'Lato',sans-serif;" role="presentation"
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:15px;font-family:'Lato',sans-serif;"
                                                ...
                                                <table height="0px" align="center" border="0"
                                                       cellpadding="0" cellspacing="0" width="100%"
                                                       style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 1px solid #46cbe3;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                    <tbody>
                                                    <tr style="vertical-align: top">
                                                        <td
                                                            style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;font-size: 0px;line-height: 0px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
