                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('projects.update', $data->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="url" placeholder="Project url" value="{{ old('url', $data->url) }}" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="tag" placeholder="Project tags" value="{{ old('tag', $data->tag) }}" id="example-text-input">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
